      ...
      <div class="social-wrapper">
        <div class="social-actions">
          ...
          <div class="inner-wrapper">
            ...
            <!-- <iframe style="width: 91px; height: 21px;"src="https://yvoschaap.com/producthunt/counter.php#href=https%3A%2F%2Fwww.producthunt.com%2Fr%2Fp%2F112998&layout=wide" width="56" height="65" scrolling="no" frameborder="0" allowtransparency="true"></iframe> -->
          </div>
        </div>
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link " href="form-components.php">
                ...
                <span>Gestion d'equipement</span>
              </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="tableaudmd.php">
                  <i class="material-icons">view_module</i>
                  <span>Liste de demande</span>
                </a>
              </li>
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4 mb-3 border-bottom">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Gestion d'equipement</h3>
              </div>
            </div>   
            <div class="row">
              <div class="col-lg-4 mb-4">
                ...
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">Ajout des equipements</h6>
                  </div>
                  <form action="ajout_equipement.php"  method="post"><br>
                    ...
                    <div class="form-wrapper">
                      <input type="text" name="fournisseur"  placeholder="nom_fournisseur " class="form-control">
                      <i class="zmdi zmdi-caret-down" style="font-size: 17px"></i>
                    </div>
                  ...
                  <div class="col">
                    <div class="card card-small overflow-hidden mb-4">
                      <div class="card-header bg-dark">
                        <h6 class="m-0 text-white">Liste</h6>
                      </div>
                        ...
                        <table class="table table-dark mb-0">
                          <thead class="thead-dark">
                            <tr>
                              ...
                              <th scope="col" class="border-bottom-0">Nom_equipement</th>
                              <th scope="col" class="border-bottom-0">Quantite</th>
                              <th scope="col" class="border-bottom-0">date</th>
                              <th scope="col" class="border-bottom-0">Prix</th>
                              <th scope="col" class="border-bottom-0">Nom_fournisseur</th>
                              <th scope="col" class="border-bottom-0">voir</th>
                            </tr>
                          </thead>
                          <tbody>
                          <?php 
                           $serveur = "mysql-technicien.alwaysdata.net";
                            ...
                            <tr>
                                ...
                                <td>
                                   <td>
                                    <form action="delete-equip.php?id=<?php echo $row['id']; ?>"  method="POST">
                                   ...
                                   <td>
                                    <form action="modifier-equip.php?id=<?php echo $row['id']; ?>" method="POST">
                                      ...
                                      <div class="modal-dialog">
                                        ...
                                        <mdiv class="modal-content">
                                          ...
                                          <div class="modal-body">
                                                ...
                                                <div class="form-wrapper">
                                                  <input type="text" name="quantite" id="" placeholder="quantite " class="form-control">
                                                  <i class="zmdi zmdi-email"></i>
                                                </div><br></br>
                                                <div class="form-wrapper">
                                                ...
                                                <div class="form-group">
                                                  <input type="text" id="" name="date" placeholder="date" class="form-control">
                                                </div><br></br>
                                                 <div class="form-group">
                                                  <input type="text" id="" name="fournisseur" placeholder="fournisseur" class="form-control">
                                                </div><br></br>
