...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <link rel="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Liste des techniciens</h3>
              </div>
            </div>
            <!-- <a href="components-blog-posts.php">
            <button type="button" class="btn btn-primary btn-lg">Ajouter un technicien</button>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <form action="enregistrer_technicien.php" method="post">
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-0">Sexe</th>
                      ...
                      <tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="modifier.php?id=<?php echo $row['id']; ?>" method="POST">
                                      ...
                                      <div class="modal-dialog">
                                        ...
                                        <mdiv class="modal-content">
                                          ...
                                          <div class="modal-body">
                                                ...
                                                <h3>Modification</h3>
                                                <div class="form-group">
                                                  <input type="text" id="nom" name="nom" placeholder="nom <?php echo $row['nom']; ?>" class="form-control">
                                                </div><br></br>
                                                <div class="form-wrapper">
                                                  <input type="text" name="adresse" id="adresse" placeholder="adresse " class="form-control">
                                                  <i class="zmdi zmdi-email"></i>
                                                ...
                                                <div class="form-wrapper">
                                                  <select name="sexe" id="sexe" class="form-control">
                                                    <option value="<?php echo $row['sexe']; ?>" disabled selected>sexe</option>
                                                    <option value="masculin">Masculin</option>
                                                    <option value="feminin">Feminin</option>
                                                  </select>
                                                </div><br></br>
                                                ...
                                                <div class="form-group">
                                                  <input type="text" id="nom" name="statut" placeholder="<?php echo $row['statut']; ?>" class="form-control">
                                                </div><br></br>
